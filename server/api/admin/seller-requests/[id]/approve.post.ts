  ...
  try {
    ...
    await sendEmail(
      ...
      `<div style="font-family:Arial,sans-serif;max-width:480px;margin:0 auto;padding:24px;border:1px solid #e2e8f0;border-radius:12px">
        ...
        <p style="text-align:center;margin:20px 0"><a href="${process.env.APP_BASE_URL || 'https://gsa-store.fr'}/seller/account" style="background:#2f7df6;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:700">Accéder à mon espace vendeur</a></p>
      </div>`
    )
