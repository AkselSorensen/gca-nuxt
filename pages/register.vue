<template>
  <div ref="pageRef" class="auth-page">
    <div class="auth-card anim-scale">
      ...
      <div v-if="!discordRequired" class="auth-form discord-register">
        <button class="btn-discord-main anim-up" @click="registerDiscord">
      ...
      <form v-if="!discordRequired && !showVerify" @submit.prevent="handleRegister" class="auth-form">
