...
.join-icon { width:64px; height:64px; margin:0 auto; border-radius:50%; background:rgba(88,101,242,0.1); border:1px solid rgba(88,101,242,0.2); display:grid; place-items:center; color:#5865f2; }
